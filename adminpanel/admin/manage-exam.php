        ...
        <div class="app-main__inner">
            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-header">
                            <i class="header-icon lnr-license icon-gradient bg-plum-plate"></i> Exam Questions 
                                                    ...
                                                    <?php 
                                                        ...
                                                        while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                            <tr>
                                                                <td>
                                                                    <b><?php echo $i++ ; ?>.) 
                                                                        <?php echo htmlspecialchars($selQuestionRow['exam_question'], ENT_QUOTES, 'UTF-8'); ?>
                                                                    </b><br>
                
                                                                    <?php 
                                                                    // Choices A, B, C, D - Highlight correct answer
                                                                    $choices = [
                                                                        'A' => $selQuestionRow['exam_ch1'],
                                                                        'B' => $selQuestionRow['exam_ch2'],
                                                                        'C' => $selQuestionRow['exam_ch3'],
                                                                        'D' => $selQuestionRow['exam_ch4']
                                                                    ];
                
                                                                    foreach ($choices as $key => $choice) {
                                                                        $isCorrect = ($choice == $selQuestionRow['exam_answer']) ? 'text-success' : '';
                                                                        echo '<span class="pl-4 ' . $isCorrect . '">' . $key . ' - ' . 
