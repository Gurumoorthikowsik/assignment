        ...
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="fullname" id="fullname" class="form-control" placeholder="Input Fullname" autocomplete="off" required>
            </div>
            <div class="form-group">
              <label>Gender</label>
            ...
            <div class="form-group">
              ...
              <input type="text" name="email" id="email" class="form-control" placeholder="Enter Username" autocomplete="off" required>
            </div>
